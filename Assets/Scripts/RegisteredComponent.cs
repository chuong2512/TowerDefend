...
public abstract class RegisteredComponent : MonoBehaviour, IRegisteredComponent
{
	...
	protected virtual void Awake()
	{
		...
		{
			UnityEngine.Debug.LogWarning("RegisteredComponent: Awake() / OnDestroy() not correctly called. Object: " + base.name);
		}
	}
	...
	protected virtual void OnDestroy()
	{
		...
		{
			UnityEngine.Debug.LogWarning("RegisteredComponent: Awake() / OnDestroy() not correctly called. Object: " + base.name + " isRegistered:" + isRegistered + " isUnregistered:" + isUnregistered);
		}
	}
