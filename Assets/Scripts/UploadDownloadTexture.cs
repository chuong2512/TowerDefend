...
public class UploadDownloadTexture : MonoBehaviour
{
	...
	private void Start()
	{
		if (mode == Mode.Upload)
		{
			...
			if (texture == null)
			{
				UnityEngine.Debug.LogError("There is no texture attached to this object.");
			}
			else
			{
	...
	private IEnumerator Upload(Texture2D texture)
	{
		...
		if (web.isError)
		{
			UnityEngine.Debug.LogError(web.errorCode + ":" + web.error);
		}
		else
		{
			UnityEngine.Debug.Log("Uploaded Successfully. Reload scene to load texture into blank object.");
		}
	}
	...
	private IEnumerator Download()
	{
		...
		else
		{
			...
			UnityEngine.Debug.Log("Texture successfully downloaded and applied to blank object.");
		}
	}
	...
	private void SetTexture(Texture2D texture)
	{
		...
		{
			UnityEngine.Debug.LogError("There is no material attached to this object.");
		}
	}
}
