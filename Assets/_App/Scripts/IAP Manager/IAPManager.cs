...
public class IAPKey
{
    public const string PACK1 = "tower_def_add1";
    public const string PACK2 = "tower_def_add2";
    public const string PACK3 = "tower_def_add3";
    public const string PACK4 = "tower_def_add5";
    public const string PACK5 = "tower_def_add10";
    public const string PACK6 = "tower_def_add20";
}
